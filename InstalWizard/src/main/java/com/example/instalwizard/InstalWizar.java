package com.example.instalwizard;
...
public class InstalWizar extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        root.getChildren().addAll(progressBar, nextButton, exitButton, statusLabel);
...
//                String jdkInstallerPath = "C:\\Users\\user\\Downloads\\jdk-installer.exe";
                ...
                String jdkInstallerPath = userHomeDirectory + File.separator + "Downloads" + File.separator + "jdk-installer.exe";
