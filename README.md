...
- [Use IntelliJ IDEA to create an EXECUTABLE JAR With Dependencies Using Maven](https://youtu.be/870XIYMrlSo) - YouTube Video shows how to create a jar file from JavaFX 11 or above with IntelliJ. 
```
